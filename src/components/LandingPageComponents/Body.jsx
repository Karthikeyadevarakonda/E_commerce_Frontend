...
const Body = () => {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center bg-gradient-to-r from-pink-50 to-gray-50 overflow-hidden pt-30 sm:pt-10 lg:pt-2 2xl:pt-20">
      ...
      <div className="absolute -bottom-20 sm:bottom-10 flex justify-center w-full z-10 rounded-full">
